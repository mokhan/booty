  ...
  module Sessions
    class CreateCommand < RouteCommand
      ...
      def respond_to(request)
        ...
        HtmlResponse.new(:template => 'create.html.erb', :model => OpenStruct.new(:code => '', :client_id => '', :client_secret => '', :redirect_uri => '', :grant_type => 'authorization_code'))
      end
